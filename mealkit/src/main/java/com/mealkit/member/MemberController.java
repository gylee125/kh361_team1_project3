...
public class MemberController{    
    ...
    public String updatePwd(@RequestParam("pw") String pw, HttpSession session, HttpServletRequest request) throws Exception {
	...
	public String deleteAccount(@RequestParam String mId, HttpSession session) throws Exception {	

			...
			<div class="alertPart">			
		      <div class="alert alert-success alert-common" role="alert">
		         <i class="tf-ion-alert-circled"></i>
		           <span>
		             회원 탈퇴 시 고객님의 정보는 상품 반품 및 A/S를 위해 전자상거래 등에서 
		             소비자 보호에 관한 법률에 의거한 <br>&emsp;&ensp; 고객정보 보호정책에 따라 관리 됩니다.
		           </span><br><br>
		         <i class="tf-ion-alert-circled"></i>
		           <span>
		             고객 요구사항 처리 및 부정이용방지를 위하여 회원탈퇴 후 30일간 고객님의 
		             개인정보를 보관합니다.
		           </span><br><br>
		         <i class="tf-ion-alert-circled"></i>
		           <span>탈퇴 시 고객님께서 보유하셨던 적립금은 모두 삭제됩니다.</span>
		      </div>
	        </div>

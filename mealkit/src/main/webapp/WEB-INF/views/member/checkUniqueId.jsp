...
<body>
	...
	사용가능한 ID입니다.<br>
		 <a class="btn btn-main btn-medium" onclick="sendResultIdAvailable();">ID 사용</a>
...
이미 사용 중인 ID입니다.<br>
딴거 하세요~<br>
		<a class="btn btn-main btn-medium" onclick="window.close()">ID 다시 작성</a>
	...
	<script>
		function sendResultIdAvailable() {
			...
			var avalableId = "중복 확인 검사 완료했습니다. 해당 ID 사용가능합니다.";
			opener.document.submitSignUp.isUniqueId.value = true;
			opener.idCheckText.innerHTML = avalableId;
